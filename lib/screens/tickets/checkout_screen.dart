...
class _CheckoutScreenNewState extends State<CheckoutScreenNew> {
  ...
  Future<void> _loadChecklistData() async {
    ...
    try {
      _hasExistingChecklist = _ticket.checkoutChecklist?.exists ?? false;
    } finally {
  ...
  Future<void> _submit() async {
    ...
    try {
      // Agregar fecha al momento de enviar
      _checklistData['fecha'] = DateTime.now().toString().split(' ')[0];
      
      // Convertir kilometrajes a double si existen
      if (_checklistData['kilometraje_inicial'] != null) {
        final km = _checklistData['kilometraje_inicial'];
        if (km is String) {
          _checklistData['kilometraje_inicial'] = double.tryParse(km);
        }
      }
    ...
    return Scaffold(
      ...
      body: _isLoading
          ...
          : _hasExistingChecklist
              ? _buildExistingCheckoutView(scheme)
  ...
  Widget _buildExistingCheckoutView(ColorScheme scheme) {
    return Center(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Este ticket ya tiene un checkout registrado',
              ...
              child: Column(
                children: [
                  ...
                  children: [
                    FormInputWidget(
                      label: 'Folio',
                      value: _checklistData['folio']?.toString() ?? '',
                      onChanged: (_) {},
                      readOnly: true,
                    ),
                    FormInputWidget(
                      label: 'Destino',
                      value: _checklistData['destino']?.toString() ?? '',
                      onChanged: (v) => setState(() => _checklistData['destino'] = v),
                      readOnly: true,
                    ),
                    FormInputWidget(
                      label: 'Modelo',
                      value: _checklistData['modelo']?.toString() ?? '',
                      onChanged: (v) => setState(() => _checklistData['modelo'] = v),
                      readOnly: true,
                    ),
                    FormInputWidget(
                      label: 'Placas',
                      value: _checklistData['placas']?.toString() ?? '',
                      onChanged: (v) => setState(() => _checklistData['placas'] = v),
                      readOnly: true,
                    ),
                    FormInputWidget(
                      label: 'Marca',
                      value: _checklistData['marca']?.toString() ?? '',
                  ...
                  Visibility(
                    ...
                    children: [
                      FormInputWidget(
                        label: 'Hora Salida',
                        hint: _checklistData['hora_salida']?.toString() ?? '09:00',
                      ...
                      FormInputWidget(
                        label: 'Km Inicial',
                        hint:  'Ej: 15000',
                        value: _checklistData['kilometraje_inicial']?.toString() ?? '0',
                        keyboardType: TextInputType.number,
                        onChanged: (v) => setState(() => _checklistData['kilometraje_inicial'] = v),
                        readOnly: false,
                      ),
                      FormDropdownWidget(
                  ...
                  children: [
                    GridView.count(
                      ...
                      crossAxisSpacing: 8,
                      children: [
                        ChecklistCheckboxWidget(label: 'Parabrisas', value: _checklistData['parabrisas'] ?? true, onChanged: (_) => setState(() => _checklistData['parabrisas'] = !(_checklistData['parabrisas'] ?? true))),
                        ChecklistCheckboxWidget(label: 'Cofre', value: _checklistData['cofre'] ?? true, onChanged: (_) => setState(() => _checklistData['cofre'] = !(_checklistData['cofre'] ?? true))),
                        ChecklistCheckboxWidget(label: 'Parrilla', value: _checklistData['parrilla'] ?? true, onChanged: (_) => setState(() => _checklistData['parrilla'] = !(_checklistData['parrilla'] ?? true))),
                        ChecklistCheckboxWidget(label: 'Defensas', value: _checklistData['defensas'] ?? true, onChanged: (_) => setState(() => _checklistData['defensas'] = !(_checklistData['defensas'] ?? true))),
                        ChecklistCheckboxWidget(label: 'Molduras', value: _checklistData['molduras'] ?? true, onChanged: (_) => setState(() => _checklistData['molduras'] = !(_checklistData['molduras'] ?? true))),
                        ChecklistCheckboxWidget(label: 'Placa', value: _checklistData['placa'] ?? true, onChanged: (_) => setState(() => _checklistData['placa'] = !(_checklistData['placa'] ?? true))),
                        ChecklistCheckboxWidget(label: 'Salpicadera', value: _checklistData['salpicadera'] ?? true, onChanged: (_) => setState(() => _checklistData['salpicadera'] = !(_checklistData['salpicadera'] ?? true))),
                  ...
                  children: [
                    GridView.count(
                      ...
                      children: [
                        ...
                        ChecklistCheckboxWidget(label: 'Direccional Der', value: _checklistData['direccional_derecha'] ?? true, onChanged: (_) => setState(() => _checklistData['direccional_derecha'] = !(_checklistData['direccional_derecha'] ?? true))),
                        ChecklistCheckboxWidget(label: 'Direccional Izq', value: _checklistData['direccional_izquierda'] ?? true, onChanged: (_) => setState(() => _checklistData['direccional_izquierda'] = !(_checklistData['direccional_izquierda'] ?? true))),
                  ...
                  children: [
                    GridView.count(
                      ...
                      children: [
                        ...
                        ChecklistCheckboxWidget(label: 'Licencia OK', value: _checklistData['licencia_conducir_vigente'] ?? true, onChanged: (_) => setState(() => _checklistData['licencia_conducir_vigente'] = !(_checklistData['licencia_conducir_vigente'] ?? true))),
                  ...
                  children: [
                    GridView.count(
                      ...
                      children: [
                        ...
                        ChecklistCheckboxWidget(label: 'AC', value: _checklistData['controles_ac'] ?? true, onChanged: (_) => setState(() => _checklistData['controles_ac'] = !(_checklistData['controles_ac'] ?? true))),
                  ...
                  children: [
                    GridView.count(
                      ...
                      crossAxisSpacing: 8,
                      children: [
                        ChecklistCheckboxWidget(label: 'Aceite', value: _checklistData['nivel_aceite_motor'] ?? true, onChanged: (_) => setState(() => _checklistData['nivel_aceite_motor'] = !(_checklistData['nivel_aceite_motor'] ?? true))),
                        ...
                        ChecklistCheckboxWidget(label: 'Frenos', value: _checklistData['nivel_liquido_frenos'] ?? true, onChanged: (_) => setState(() => _checklistData['nivel_liquido_frenos'] = !(_checklistData['nivel_liquido_frenos'] ?? true))),
                  ...
                  children: [
                    GridView.count(
                      ...
                      children: [
                        ...
                        ChecklistCheckboxWidget(label: 'Llave Ruedas', value: _checklistData['llave_ruedas'] ?? true, onChanged: (_) => setState(() => _checklistData['llave_ruedas'] = !(_checklistData['llave_ruedas'] ?? true))),
                        ChecklistCheckboxWidget(label: 'Cables', value: _checklistData['cables_pasa_corriente'] ?? true, onChanged: (_) => setState(() => _checklistData['cables_pasa_corriente'] = !(_checklistData['cables_pasa_corriente'] ?? true))),
